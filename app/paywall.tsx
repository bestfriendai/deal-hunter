...
const FEATURES = [
  { icon: '🏷️', text: 'Unlimited deals' },
  { icon: '🚫', text: 'No ads' },
  { icon: '🔔', text: 'Exclusive notifications' },
  { icon: '⭐', text: 'Priority support' },
  { icon: '📊', text: 'Deal analytics' },
  { icon: '🎯', text: 'Early access to deals' },
];

// Demo packages - in production, these come from RevenueCat
const DEMO_PACKAGES: Package[] = [
  {
    identifier: 'monthly',
    packageType: 'MONTHLY',
    storeProduct: {
      productId: 'com.dealhunter.premium.monthly',
  ...
  },
  {
    ...
    packageType: 'ANNUAL',
    storeProduct: {
      productId: 'com.dealhunter.premium.annual',
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>DealHunter Premium</Text>
          <Text style={styles.subtitle}>Unlock all features and save more!</Text>
        </View>
