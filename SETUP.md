...
3. Create new project: "DealHunter"
...
2. Create two products:
   - **Monthly Subscription**: Product ID `com.dealhunter.premium.monthly`, Price: $4.99
   - **Annual Subscription**: Product ID `com.dealhunter.premium.annual`, Price: $39.99
...
2. Apps → Create App
3. Name: DealHunter
4. Package name: com.dealhunter.app
